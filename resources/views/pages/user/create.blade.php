                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('add-users') }}" method="post">
                            ...
                            <div class="form-group">
                                <label>Email</label>
                                <input type="email" class="form-control form-control-sm @error('email') is-invalid @enderror" value="{{ old('email') }}"
                                    placeholder="Masukkan Email" autocomplete="email" name="email" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control form-control-sm @error('password') is-invalid @enderror" autocomplete="new-password"
